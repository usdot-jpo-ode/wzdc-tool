...
class SettingsFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.connectionStringValid.observe(viewLifecycleOwner, {
            if (it.valid) {
    ...
    private fun processAzureSettings() {
        ...
        try {
            viewModel.verifyUpdateAzureInfo(azureInfo)
        }
        catch (e: Exception) {
//            viewModel.connectionStringValid
        }
    }
